...
RANK_BY="mean_acc_gain"  # Options: "snr_prob_gain", "mean_prob_gain", "snr_acc_gain", "mean_acc_gain"

# Create logs directory if it doesn't exist
mkdir -p logs

accelerate launch --num_processes 3 test_best_worst_demo_accelerate.py \
