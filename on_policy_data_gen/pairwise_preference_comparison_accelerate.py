...
class PairwiseComparisonDataset(Dataset):
    ...
    def _create_prompt_template(self, question, response_a, response_b):
        """Create a prompt template for pairwise comparison."""
        content = f"""Please compare the following two responses to the given question and determine which one is better. Output your choice as either [[A]] or [[B]].
...
def main():
    ...
    comparison_dataset = PairwiseComparisonDataset(dataset, tokenizer, args.max_length)
        ...
        try:
            ...
            for i, (prob_a_over_b, logit_a, logit_b) in enumerate(batch_results):
                ...
                result = {
                    ...
                    'original_rm_scores': metadata['original_rm_scores'],
                    'comparison_prompt': metadata['comparison_prompt'],
