...
def evaluate_kshot_prompt(
    ...
    """
    Evaluate a single test example with k-shot demonstrations.
    ...
    token_logprobs = client.get_token_probabilities(prompt, ["A", "B"])
...
def evaluate_test_example_worker(args_tuple):
    ...
    Args:
        args_tuple: Tuple of (test_idx, test_example, client_args, sampled_demos, sampled_flips)
    ...
    """
    test_idx, test_example, client_args, sampled_demos, sampled_flips = args_tuple
    ...
    for ordering in [0, 1]:
        log_prob, prob = evaluate_kshot_prompt(
            client, test_example, sampled_demos, sampled_flips, ordering
        )
...
def main():
    ...
    for sample_idx in range(args.num_samples):
        ...
        if args.num_workers > 1:
            ...
            worker_args = [
                (test_idx, test_example, client_args, sampled_demos, sampled_flips)
